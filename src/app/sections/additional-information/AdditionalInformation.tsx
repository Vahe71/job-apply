  ...
  return (
    <div className="mb-[44px] sm:mb-[74px] lg:mb-[57px]">
      ...
      <div className="mt-[26px]">
        ...
        <textarea onChange={(e) => onChangeApplyData('additionalInfo', e.target.value)} className={`${error ? ' border-[#ff0000] ' : ' border-[#AEB3BC] '} text-[16px] mt-[8px] w-full outline-none border-[1px] rounded-[12px] resize-none h-[228px] p-[10px]`} placeholder="Mention the reasons why you chose us."></textarea>
      </div>
    </div>
  );
};
