...
export const AboutClient: React.FC<AboutClientProps> = ({ jobData }) => {
  return (
    <div className="border-[1px] border-[#CBEC5E] rounded-[16px] p-[22px_14px] sm:p-[18px] lg:p-[28px_28px_45px] w-full 2xl:min-h-[741px] lg:min-h-[669px] min-h-[530px]">
      ...
      <div className="2xl:mt-[9px] lg:mt-[14px] sm:mt-[6px] mt-[10px] flex gap-[7px] items-center">
        <div className="flex gap-[1px]">
          ...
          {!Number.isInteger(jobData.rating) && <div className="lg:w-[16px] lg:h-[16px] w-[14px] h-[14px]"><HalfStarIcon /></div>}
      ...
      <div className="bg-[#F5F5F5] text-[#545454] text-[14px] lg:text-[16px] p-[11px] w-fit mt-[14px] lg:mt-[17px] rounded-[6px]">
        {jobData.jobLink}
      </div>
      <div
