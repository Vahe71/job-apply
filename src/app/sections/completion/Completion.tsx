      ...
      <div className="w-full max-w-[350px]">
        <label className="">
          ...
          <input
            ...
            placeholder="€ 0.0"
            className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none text-black placeholder:text-black h-[42px] border-[1px] w-full border-[#AEB3BC] rounded-[12px] outline-0 p-[9px_8px] mt-[8px]"
            type="number"
          />
        </label>
      </div>
